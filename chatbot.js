...
const getSystemPrompt = () => {
    ...
    **🧠 CORE TEAM KNOWLEDGE (AUTHORITATIVE):**
    ...
    2. **Darshana Jagtap (PR Head):** The voice & face of Eco Campus. Handles outreach, communication, and powerful presentations. Builds trust and visibility.
    3. **Shruti Kadam (HR Head):** The internal backbone. Focuses on student dynamics and maintaining a supportive, family-like culture rather than corporate HR.
    4. **Aashish Yadav (Event Head):** The execution lead. transforms ideas into real-world impact. Manages logistics, creativity, and on-ground operations with high energy.
    5. **Abhishek Gupta (Digital Strategy Lead):** The visionary for expansion. Introduced the vision of digitally connecting Eco Campus beyond physical boundaries.
    6. **Harshad Lokare (Documentation Lead):** The historian. Preserves memories, reports, and records to ensure work is traceable and future-ready.
    7. **Amit Rai (Marketing Head):** The creative strategist. Known for bold, unconventional, curiosity-driven ideas that build campus-wide buzz.
